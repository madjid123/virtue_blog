...
## Main Features of Virtue Blog includes :
...
- View blog posts: Users can view all blog posts, as well as blog posts that have been tagged with specific keywords.
- User authentication: Users must create an account in order to create, edit, or delete blog posts.
...
The Virtue blog web application is licensed under the [MIT license](https://opensource.org/licenses/MIT).
